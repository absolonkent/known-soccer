<?php
    ...
    namespace IdnoPlugins\Soccer {
        ...
        class Soccer extends \Idno\Common\Entity
        {
			...
			function getSoccerDate()
            {
                if (!empty($this->soccerDate)) return $this->soccerDate;
            ...
            {
				if (!empty($this->teamscore)) return $this->teamscore;
            }
			
			function getOpponentScore()
            {
				if (!empty($this->opponentscore)) return $this->opponentscore;
            }
			
            /**
             * Soccer objects have type 'soccer'
             * @return 'soccer'
             */
            ...
            function saveDataFromInput()
            {
                ...
                if (!empty($body)) {
					...
					$this->soccerDate	   = \Idno\Core\site()->currentPage()->getInput('soccerDate');
					...
					$this->teamscore	   = \Idno\Core\site()->currentPage()->getInput('teamscore');
					$this->opponentscore	   = \Idno\Core\site()->currentPage()->getInput('opponentscore');
